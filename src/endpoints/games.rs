...
use crate::models::games::{
    AlternativeName, ContentSafetyRating, ContentSafetyRatingDimension, ExternalGame,
    ExternalGameSource, Game, GameContentSafetyRating, GameEngine, GameLocalization, GameMode,
    GameReleaseFormat, GameStatus, GameTimeToBeat, GameType, GameVersion, GameVersionFeature,
    GameVersionFeatureValue, GameVideo, Genre, InvolvedCompany, Keyword, MultiplayerMode,
    PlayerPerspective, PopularityPrimitive, PopularityType, Region, ReleaseDate, ReleaseDateRegion,
    ReleaseDateStatus,
};
...
define_endpoint! {
    /// `content_safety_ratings` - not searchable.
    pub struct ContentSafetyRatingsEndpoint => "content_safety_ratings", ContentSafetyRating, name_filterable
}

define_endpoint! {
    /// `content_safety_rating_dimensions` - not searchable.
    pub struct ContentSafetyRatingDimensionsEndpoint => "content_safety_rating_dimensions", ContentSafetyRatingDimension, name_filterable
}
...
define_endpoint! {
    /// `game_content_safety_ratings` - not searchable.
    pub struct GameContentSafetyRatingsEndpoint => "game_content_safety_ratings", GameContentSafetyRating
}
